...
func (v Vector2i) X() int64     { return int64(v[0]) }
func (v Vector2i) Y() int64     { return int64(v[1]) }
func (v Vector2i) SetX(x int64) { v[0] = int32(x) }
func (v Vector2i) SetY(y int64) { v[1] = int32(y) }
...
func (v Vector2i) Vector2() Vector2 { return Vector2{float(v[0]), float(v[1])} } //Vector2(Vector2i)

// Abs returns a new vector with all components in absolute values (i.e. positive).
func (v Vector2i) Abs() Vector2i { return v.abs() } //Vector2i.abs

// Aspect returns the aspect ratio of this vector, the ratio of x to y.
func (v Vector2i) Aspect() float64 { return float64(v[0]) / float64(v[1]) } //Vector2i.aspect
...
func (v Vector2i) Clamp(min, max Vector2i) Vector2i { //Vector2i.clamp
	return Vector2i{
...
func (v Vector2i) Length() float64 { return Sqrt(float64(v.LengthSquared())) } //Vector2i.length
...
func (v Vector2i) LengthSquared() int64 { return int64(v[x]*v[x] + v[y]*v[y]) } //Vector2i.length_squared
...
func (v Vector2i) MaxAxis() Axis { //Vector2i.max_axis_index
	if v[Y] > v[X] {
		return Y
	}
	return X
...
func (v Vector2i) MinAxis() Axis { //Vector2i.min_axis_index
	if v[Y] < v[X] {
		return Y
	}
	return X
...
func (v Vector2i) Sign() Vector2i { return v.sign() } //Vector2i.sign

// Snapped returns a new vector with each component snapped to the closest multiple of the corresponding
// component in step.
func (v Vector2i) Snapped(step Vector2i) Vector2i { //Vector2i.snapped
	return Vector2i{
		Snappedi(v[0], step[0]),
		Snappedi(v[1], step[1]),
	}
...
func (v Vector2i) Add(other Vector2i) Vector2i { return Vector2i{v[x] + other[x], v[y] + other[y]} } //Vector2i + Vector2i
func (v Vector2i) Sub(other Vector2i) Vector2i { return Vector2i{v[x] - other[x], v[y] - other[y]} } //Vector2i - Vector2i
func (v Vector2i) Mul(other Vector2i) Vector2i { return Vector2i{v[x] * other[x], v[y] * other[y]} } //Vector2i * Vector2i
func (v Vector2i) Div(other Vector2i) Vector2i { return Vector2i{v[x] / other[x], v[y] / other[y]} } //Vector2i / Vector2i
func (v Vector2i) Mod(other Vector2i) Vector2i { return Vector2i{v[x] % other[x], v[y] % other[y]} } //Vector2i % Vector2i
func (v Vector2i) Addi(other int64) Vector2i { //Vector2i + int64
	return Vector2i{v[x] + int32(other), v[y] + int32(other)}
}
func (v Vector2i) Subi(other int64) Vector2i { //Vector2i - int64
	return Vector2i{v[x] - int32(other), v[y] - int32(other)}
}
func (v Vector2i) Muli(other int64) Vector2i { //Vector2i * int64
	return Vector2i{v[x] * int32(other), v[y] * int32(other)}
}
func (v Vector2i) Divi(other int64) Vector2i { //Vector2i / int64
	return Vector2i{v[x] / int32(other), v[y] / int32(other)}
}
func (v Vector2i) Modi(other int64) Vector2i { //Vector2i % int64
	return Vector2i{v[x] % int32(other), v[y] % int32(other)}
}
func (v Vector2i) Neg() Vector2i { return Vector2i{-v[x], -v[y]} } //-Vector2i
