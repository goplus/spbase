...
func NewRect2(x, y, width, height float64) Rect2 { //Rect2(float,float,float,float)
...
func (r Rect2) Rect2i() Rect2i { //Rect2i(Rect2)
	return Rect2i{
...
func (r Rect2) Abs() Rect2 { //Rect2.abs
...
func (r Rect2) Encloses(b Rect2) bool { //Rect2.encloses
...
func (r Rect2) Expand(to Vector2) Rect2 { //Rect2.expand
...
func (r Rect2) Area() float64 { return float64(r.Size[X] * r.Size[Y]) } //Rect2.area

// Center returns the center point of the rectangle. This is the same as position + (size / 2.0).
func (r Rect2) Center() Vector2 { return r.Position.Add(r.Size.Divf(2)) } //Rect2.center
...
func (r Rect2) Grow(amount float64) Rect2 { //Rect2.grow
...
func (r Rect2) GrowIndividual(left, top, right, bottom float64) Rect2 { //Rect2.grow_individual
...
func (r Rect2) GrowSide(side Side, amount float64) Rect2 { //Rect2.grow_side
	switch side {
	case SideLeft:
...
func (r Rect2) Intersects(b Rect2, include_borders bool) bool { //Rect2.intersects
	if include_borders {
...
func (r Rect2) IsApproximatelyEqual(b Rect2) bool { //Rect2.is_equal_approx
...
func (r Rect2) IsFinite() bool { //Rect2.is_finite
...
func (r Rect2) Merge(b Rect2) Rect2 { //Rect2.merge
	var new_rect Rect2
